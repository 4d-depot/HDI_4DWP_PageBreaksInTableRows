...
Case of 
	...
	Else 
		...
		$options.title:=""
		$options.title:=$options.title+"allow automatic page breaks inside rows of 4D Write Pro tables?"  //+"\n"
		...
		$options.minimumVersion:="1940"  // 1940 means 19R4   1701 means 17.1 (do not use !)
